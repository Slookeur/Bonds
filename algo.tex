...
\Procedure{pbc\_shift}{\xdir, \ydir, \zdir, \xydir, \xyzdir, pixel[\trois], shift[\trois][\trois][\trois]}
  \State
  \Sate Input:
  \Sate   - \xdir\ is the number of pixels in the x direction
  \Sate   - \ydir\ is the number of pixels in the y direction
  \Sate   - \zdir\ is the number of pixels in the z direction
