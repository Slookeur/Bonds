...
\begin{algorithm}
\begin{algorithmic}[1]
\Procedure{shift}{\xdir, \ydir, \zdir, \xydir, \xyzdir, pixel[\trois], shift[\trois][\trois][\trois]}
%\Procedure{shift}{{\footnotesize{\xdir, \ydir, \zdir, \xydir, \xyzdir, pixel[\trois], shift[\trois][\trois][\trois]}}}
