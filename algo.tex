...
\Procedure{Adjust PBC shift}{pixel\_grid, pixel\_coord[3], pbc\_shift[3][3][3]}
  \State \For{\vbtt{x\_pos} = 1, $\dots$, \trois}
    \State \For{\rbtt{y\_pos} = 1, $\dots$, \trois}
      \State \For{\obtt{z\_pos} = 1, $\dots$, \trois}
        \State pbc\_shift[\vbtt{x\_pos}][\rbtt{y\_pos}][\obtt{z\_pos}] = \zero
      \EndFor
    \EndFor
  \EndFor
  
  \State \If{pixel\_coord[\zero] = \zero}
    \State \For{\rbtt{y\_pos} = 1, $\dots$, \trois}
      \State \For{\obtt{z\_pos} = 1, $\dots$, \trois}
	\State pbc\_shift[\zero][\rbtt{y\_pos}][\obtt{z\_pos}] = grid.n\_pix[\zero]
      \State \EndFor
    \State \EndFor
  \State \ElsIf{pixel\_coord[\zero] = grid.n\_pix[\zero]-1}
    \State \For{\rbtt{y\_pos} = 1, $\dots$, \trois}
      \State \For{\obtt{z\_pos} = 1, $\dots$, \trois}
	\State pbc\_shift[\zero][\rbtt{y\_pos}][\obtt{z\_pos}] = - grid.n\_pix[\zero]
      \State \EndFor
  ...
  \State \If{pixel\_coord[\un] = \zero}
    \State \For{\vbtt{x\_pos} = 1, $\dots$, \trois}
      \State \For{\obtt{z\_pos} = 1, $\dots$, \trois}
	\State pbc\_shift[\vbtt{x\_pos}][\zero][\obtt{z\_pos}] += grid.n\_xy
      \State \EndFor
    \State \EndFor
  \State \ElsIf{pixel\_coord[\un] = grid.n\_pix[\un]-1}
    \State \For{\vbtt{x\_pos} = 1, $\dots$, \trois}
      \State \For{\obtt{z\_pos} = 1, $\dots$, \trois}
	\State pbc\_shift[\vbtt{x\_pos}][\zero][\obtt{z\_pos}] -= grid.n\_xy
      \State \EndFor
  ...
  \State \If{pixel\_coord[\deux] = \zero}
    \State \For{\vbtt{x\_pos} = 1, $\dots$, \trois}
      \State \For{\rbtt{y\_pos} = 1, $\dots$, \trois}
	\State pbc\_shift[\vbtt{x\_pos}][\rbtt{y\_pos}][\zero] += grid.pixels
      \State \EndFor
    \State \EndFor
  \State \ElsIf{pixel\_coord[\deux] = grid.n\_pix[\deux]-1}
    \State \For{\vbtt{x\_pos} = 1, $\dots$, \trois}
      \State \For{\rbtt{z\_pos} = 1, $\dots$, \trois}
	\State pbc\_shift[\vbtt{x\_pos}][\rbtt{y\_pos}][\deux] -= grid.pixels
      \State \EndFor
    \State \EndFor
  \State \EndIf
\EndProcedure
