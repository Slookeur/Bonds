...
\Procedure{Adjust PBC shift}{pixel\_grid, pixel\_coord[3], pbc\_shift[3][3][3]}
  ...
  y
  \If{pixel\_coord[\un] = \un}
    \For{\rbtt{y\_pos} = \un, $\dots$, \trois}
      \For{\obtt{z\_pos} = \un, $\dots$, \trois}
        \State pbc\_shift[\un][\rbtt{y\_pos}][\obtt{z\_pos}] = \xdir
      \EndFor
    \EndFor
  \ElsIf{pixel\_coord[\un] = \xdir}
    \For{\rbtt{y\_pos} = \un, $\dots$, \trois}
      \For{\obtt{z\_pos} = \un, $\dots$, \trois}
        \State pbc\_shift[\trois][\rbtt{y\_pos}][\obtt{z\_pos}] = - \xdir
      \EndFor
    \EndFor
  \EndIf

  \If{pixel\_coord[\deux] = \un}
    \For{\vbtt{x\_pos} = \un, $\dots$, \trois}
      \For{\obtt{z\_pos} = \un, $\dots$, \trois}
	\State pbc\_shift[\vbtt{x\_pos}][\un][\obtt{z\_pos}] += (\xdir $\times$ \ydir)
      \EndFor
    \EndFor
  \ElsIf{pixel\_coord[\deux] = \ydir}
    \For{\vbtt{x\_pos} = \un, $\dots$, \trois}
      \For{\obtt{z\_pos} = \un, $\dots$, \trois}
        \State pbc\_shift[\vbtt{x\_pos}][\trois][\obtt{z\_pos}] -= (\xdir $\times$ \ydir)
      \EndFor
    \EndFor
  \EndIf
  ...
  \If{pixel\_coord[\trois] = \un}
    \For{\vbtt{x\_pos} = \un, $\dots$, \trois}
      \For{\rbtt{y\_pos} = \un, $\dots$, \trois}
        \State pbc\_shift[\vbtt{x\_pos}][\rbtt{y\_pos}][\un] += (\xdir $\times$ \ydir $\times$ \zdir)
      \EndFor
    \EndFor
  \ElsIf{pixel\_coord[\trois] = \zdir}
    \For{\vbtt{x\_pos} = \un, $\dots$, \trois}
      \For{\rbtt{z\_pos} = \un, $\dots$, \trois}
        \State pbc\_shift[\vbtt{x\_pos}][\rbtt{y\_pos}][\trois] -= (\xdir $\times$ \ydir $\times$ \zdir)
      \EndFor
    \EndFor
  \EndIf
\EndProcedure
