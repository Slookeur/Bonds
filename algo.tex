...
\newcommand{\xydir}{\dbtt{xy}}
\newcommand{\xyzdir}{\rbtt{xyz}}
...
\begin{algorithm}
\begin{algorithmic}[1]
\Procedure{pbc\_shift}{\xdir, \ydir, \zdir, \xydir, \xyzdir, pixel[3], shift[3][3][3]}
  ...
  \If{pixel[\deux] = \un}
    \For{\vbtt{x\_pos} = \un, $\dots$, \trois}
      \For{\obtt{z\_pos} = \un, $\dots$, \trois}
	\State pbc\_shift[\vbtt{x\_pos}][\un][\obtt{z\_pos}] += \xydir
      \EndFor
    \EndFor
  \ElsIf{pixel[\deux] = \ydir}
    \For{\vbtt{x\_pos} = \un, $\dots$, \trois}
      \For{\obtt{z\_pos} = \un, $\dots$, \trois}
        \State pbc\_shift[\vbtt{x\_pos}][\trois][\obtt{z\_pos}] -= \xydir
      \EndFor
    \EndFor
  \EndIf
  ...
  \If{pixel\_coord[\trois] = \un}
    \For{\vbtt{x\_pos} = \un, $\dots$, \trois}
      \For{\rbtt{y\_pos} = \un, $\dots$, \trois}
        \State pbc\_shift[\vbtt{x\_pos}][\rbtt{y\_pos}][\un] += \xyzdir
      \EndFor
    \EndFor
  \ElsIf{pixel\_coord[\trois] = \zdir}
    \For{\vbtt{x\_pos} = \un, $\dots$, \trois}
      \For{\rbtt{z\_pos} = \un, $\dots$, \trois}
        \State pbc\_shift[\vbtt{x\_pos}][\rbtt{y\_pos}][\trois] -= \xyzdir
      \EndFor
    \EndFor
  \EndIf
\EndProcedure
