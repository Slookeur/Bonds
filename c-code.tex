  ...
  for ( |\vbtt{x\_pos}| = l_start[|\zero|] ; |\vbtt{x\_pos}| < l_end[|\zero|] ; |\vbtt{x\_pos}| ++ )
  {
    for ( |\rbtt{y\_pos}| = l_start[|\un|] ; |\rbtt{y\_pos}| < l_end[|\un|] ; |\rbtt{y\_pos}| ++ )
    {
      for ( |\obtt{z\_pos}| = l_start[|\deux|] ; |\obtt{z\_pos}| < l_end[|\deux|] ; |\obtt{z\_pos}| ++ )
      {
        ...
        if ( ! use_pbc && boundary )
        {
          if (( the_pix->p_xyz[|\zero|] == |\zero| && |\vbtt{x\_pos}| == |\zero| ) |\textbar\textbar| ( the_pix->p_xyz[|\zero|] == the_grid->n_pix[|\zero|] && |\vbtt{x\_pos}| == |\deux| ))
          {
            keep_neighbor = FALSE;
          }
          else if (( the_pix->p_xyz[|\un|] == |\zero| && |\rbtt{y\_pos}| == |\zero| ) |\textbar\textbar| ( the_pix->p_xyz[|\un|] == the_grid->n_pix[|\un|] && |\rbtt{y\_pos}| == |\deux| ))
          {
            keep_neighbor = FALSE;
          }
          else if (( the_pix->p_xyz[|\deux|] == |\zero| && |\obtt{z\_pos}| == |\zero| ) |\textbar\textbar| ( the_pix->p_xyz[|\deux|] == the_grid->n_pix[|\deux|] && |\obtt{z\_pos}| == |\deux| ))
          {
            keep_neighbor = FALSE;
          }
        }
