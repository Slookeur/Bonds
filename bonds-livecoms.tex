...
F_{axis}(ab) & = & \lVert f_{c,axis}(ab) \rVert \\[0.125cm]
Fmin_{axis}(ab) & = & \min\left[F_{axis}(ab),i\ 1.0-F_{axis}(ab)\right] \\[0.125cm]
f_{axis}(ab) & = & \frac{f_{c,axis(ab)}}{F_{axis}(ab)} \times Fmin_{axis}(ab) \\[0.125cm]
