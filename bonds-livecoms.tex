...
The pixel dimension $\Pc$ should be close but sligtly superior to $\Rc$ the cutoff radius used to search for first neighbors atoms, ex: $\Pc = \Rc + 0.5$. \\
\\ 
...
And: 
\begin{equation}
n_{p}(xyy) = n_{p}(x) \times n_{p}(y) \times n_{p}(z)
\end{equation}
\vspace{0.125cm}
