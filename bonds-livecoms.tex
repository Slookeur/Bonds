...
\noindent Box, or lattice parameters can be expressed with two different sets of parameters, using either: 
\begin{itemize}
...
\end{equation}
Where $D_{max}(axis)$ is the maximum interatomic distance separating two atoms on $axis$, and $\Pc \simeq \Rc$ is the pixel dimension, close to the cutoff distance that separates neighbor atoms. \\
