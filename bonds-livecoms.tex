...
\begin{itemize}
\item Choose a cutoff radius ${\textrm{R}_{cut}}$ to determine first neighor atoms, compute and save ${\textrm{R}_{cut}}^2$
...
\begin{itemize}
\item Search for neighbors between the atoms of pixel $pix$ as well as the atoms of its surrouding pixel neighbors $pjx$
\begin{itemize}
